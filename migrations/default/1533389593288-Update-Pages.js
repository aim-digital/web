...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    description = 'Statistics show that 70% of software projects fail, with $150B spent on software waste annually. Our consulting experience has led us to our mission of solving this problem.';
    ...
    title = 'SQUAD™ PLM Pricing';
    description = 'No more nickel-and-diming over hours. We’re bottom-line thinkers who know what software projects cost. Why not make project planning simpler with bottom-line monthly pricing?';
