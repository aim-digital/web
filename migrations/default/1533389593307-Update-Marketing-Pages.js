...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    route = 'squad';
    title = 'Rapid Timebox Methodology';
    description = "We manage chaos by timeboxing rapid iterations of the product lifecycle, project budget planning, and daily team operations.";
