...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    const DESCRIPTION = 'Speed, accuracy, value, and iteration are the core mission themes applied through our software consulting services to guard against software waste.';
    ...
    route = 'about';
    section = 'Mission';
    title = 'Speed, Accuracy, Value. Repeat.';
