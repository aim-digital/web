...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    description = 'The SQUAD™ product lifecycle is our project management framework, inspired by our mission to prevent projects from burning through capital.';
    ...
    description = 'We broker up to 4 months of guaranteed software development services as the second SQUAD™ lifecycle stage.';
    ...
    description = 'The last stage of the SQUAD™ lifecycle is dedicated to managing live production marketing and tech support, DevOps, and continuous delivery of micro software versions.';
    ...
    description = "Agents are kept on standby, ready anytime you need us, on a story point by sprint basis with our Point & Pay™ plan.";
