...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    const DESCRIPTION = 'Speed, accuracy, and value are the core mission concepts applied through our software consulting services to guard against software waste.';
