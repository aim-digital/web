...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    description = 'Get off the ground with confidence using our time-boxed roadmap planning approach, allowing us to guarantee all development project milestones and affording you peace of mind.';
