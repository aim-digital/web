...
export default class {
  static async up(models, sequelize, DataTypes) {
    ...
    description = 'Get the first stage of your MVP off the ground with confidence using our time-boxed roadmap planning approach.';
    ...
    description = 'Build your MVP within 6 months for under $350k with our simple packaged monthly pricing.';
    ...
    description = 'Every software project we plan and develop is insured to guarantee minimum risk of delivery time, budget, and quality.';
    ...
    description = 'From web programming to project management, each of our software consultants is expertly trained in multiple roles to provide zero latency between digital development tasks, operating remotely within the U.S.A.';
