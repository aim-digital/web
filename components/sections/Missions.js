    ...
    <section key="0">
      <div className="row">
        <div className="col-lg-4 col-xs-12">
          ...
          <p>Built from our Roman-based principles, we believe design in any product must be minimal, absolutely functional, unconditionally flawless, and beautiful.</p>
          <p><em>As the Digital Special Forces™, we are the first line of defense in affecting your product’s digital presence.</em></p>
        </div>
        <div className="col-lg-4 col-xs-12 valign-middle">
          <h2 className="text-center">Remote / Control</h2>
          <p>Using state-of-the-art communication tools (Slack, Skype, G Suite, etc.), conferencing services, and optimized project management tools (JIRA), our consultants and developers are all remote-based autonomous experts.</p>
        ...
        <div className="col-lg-4 col-xs-12">
          ...
          <p><em>Foxtrot℠</em> is our project management solution, based on <em>Agile</em> process methodologies.</p>
          ...
          <p><em>Any of our three Foxtrot℠ systems is included - free of charge - with our <strong>Value</strong> or <strong>Managed</strong> plans!</em></p>
        </div>
      </div>
    ...
    return (
      <Section className={`${animating ? 'animating' : ''}`}>
        ...
        <div className="background">
          ...
          <div className="insignia image" style={{ backgroundImage: 'url(/@vitruviantech/web/images/insignia.png)', zIndex: '2' }}></div>
          <div className="image" style={{ backgroundImage: 'url(/@vitruviantech/web/images/home/missions.jpg)', opacity: '1' }}></div>
        </div>
