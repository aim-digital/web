        ...
        {[
          <div className={[styles.content, 'content', styles.virtues].join(' ')} key="0">
            <div className={styles.logo}>
              <VelocityTransitionGroup enter={{easing: [ 0.17, 0.67, 0.83, 0.67 ], animation: 'transition.whirlIn', duration: 350 }}>
                {this.state.loaded && (
                  <img src={Config.isProduction ? require('./images/insignia.png') : '/assets/images/insignia.png'}
          ...
          <div className={[styles.content, 'content', styles.services].join(' ')} key="1">
            <section className={['preview'].join(' ')}>
              ...
              <ul>
                ...
                <li>Legal <span className={[styles.service].join(' ')}>Investigatory / Collections / DV</span></li>
                <li className={'more'}/>
              </ul>
            </section>
          </div>,

          <div className={[styles.content, 'content', styles.pricing].join(' ')} key="2">
            <section className={['preview'].join(' ')}>
              <h3>Rates</h3>
              <ul>
          ...
          <div className={[styles.content, 'content', styles.pricing, styles.products].join(' ')} key="3">
            <section className={['preview'].join(' ')}>
              <h3>Plans</h3>
              <ul>
                <li><strong>App Studio</strong> <i>Web Platform</i> <span className={[styles.price].join(' ')}><strong>$2,499<sub><sup>.99</sup>/one-time</sub></strong></span></li>
                <li className={styles.asterisk}><small><i>Scalable mobile/desktop app development framework.</i></small></li>
                <li className={styles.asterisk}><small><i>Platform as a Service (PaaS), with <strong>hosting included.</strong></i></small></li>
                <li className={styles.asterisk}><small><i><strong>20 FREE hours</strong> of custom development services.</i></small></li>
                <li className={styles.asterisk}><small><i>CMS <strong>bundle integrations</strong> (i.e., Shopify, WordPress.)</i></small></li>
                <li className={styles.asterisk}><small><i><strong>Thousands</strong> of available plugins.</i></small></li>
                <li className={styles.asterisk}><small><i>Perfect for premium <strong>e-comm and publishing</strong> solutions!</i></small></li>
                <li className={styles.asterisk}><small><i>Made <strong>by</strong> developers, <strong>for</strong> developers (made in NYC.)</i></small></li>
                <li className={styles.asterisk}><small><i><strong>Swipe right</strong> or <strong>scroll down</strong> to contact us today! &darr;&rarr;</i></small></li>
            ...
            <section className={['preview'].join(' ')}>
              ...
              <ul>
                ...
                <li>
                  ...
                  <span>Reza Khan<small>/ Cloud Services</small></span>
                </li>
                <li>
                ...
                <li>
                  <a href="mailto:zach@vitruvian.tech?subject=<VitruvianTech>%20Connect" target="_blank">
                    <i className="fa fa-envelope"/>
                  </a>
                  <span>Zach Noguera<small>/ Operations</small></span>
                </li>
